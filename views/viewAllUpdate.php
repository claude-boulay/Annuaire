...
<form action="index.php?action=controllerEtudiant/Update/<?= $data[0]['etudiant_id']; ?>/<?= $data[0]['organisation_id']; ?>" method=" post">
    <center>
        ...
        <table>
            ...
            <tr>
                ...
                <td><input type="tel" name="étudiant_tel" size="50" required value="<?= $data[0]['etudiant_telephone']; ?>"></td>
            </tr>
            <tr>
                <td>Email de l'étudiant</td>
                <td><input type="text" name="étudiant_mail" size="50" required value="<?= $data[0]['etudiant_mail']; ?>"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="tel" name="organisation_tel" size="50" value="<?= $data[0]['organisation_tel'] ?>"></td>
            </tr>
            <tr>
